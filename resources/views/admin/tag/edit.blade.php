              ...
              <div class="col-6">
                <form action="{{ route('admin.tag.update', $tag->id) }}" method="POST">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="Введите название тега" value="{{ $tag->title }}">
                    @error('title')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="slug" placeholder="Введите краткое название (EN)" value="{{ $tag->slug }}">
                    @error('slug')
                        <small class="text-danger">Поле не может быть пустым</small>
                    @enderror
                  </div>
